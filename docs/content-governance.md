...
| Companies     | GraphQL metadata                   | Company team         | At least one public company list exists           | Hide the directory and keep employer contact available | Follow the current metadata edition                  |
